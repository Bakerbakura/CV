...
\begin{center} \begin{tabular}{lp{0.6\textwidth}l}
	...
	Tertiary:		& \href{http://www.uct.ac.za/}{University of Cape Town (UCT)} & 2010--2013 \\
							...
							& \multicolumn{2}{l}{\ind \ind \small{Thesis title: \textit{Analytic methods in combinatorial number theory}}} \\
							& \ind \ind \small{Supervisor: Prof Stephan Wagner} \\
							\cmidrule{2-3}
							& \href{http://www.sun.ac.za/}{Stellenbosch University (SU)}	& 2018--2020 \\
							& \ind PhD (Mathematics) received 														& \ind April 2020 \\
							& \multicolumn{2}{l}{\ind \ind \small{Thesis title: \textit{Drinfeld modular forms of higher rank from a lattice-oriented point of view}}} \\
							& \multicolumn{2}{l}{\ind \ind \small{Supervisor: Dr Dirk Basson} \ind \small{Co-supervisor: Prof Florian Breuer}} \\
	\bottomrule
\end{tabular} \end{center}
